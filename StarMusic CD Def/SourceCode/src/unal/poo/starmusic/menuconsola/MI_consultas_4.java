 ...
 * al genero indicado
 */
public class MI_consultas_4 extends OpcionDeMenu {
	public MI_consultas_4() {
		Nombre = "Consultar los artistas asociados a un genero particular";
	}
	...
	public void ejecutar() {
		...
		if (Generos.Lista_Generos.size() > 0) {
			if (Artistas.Lista_Artistas.size() > 0) {
				...
				System.out.println("Artistas asociados al genero "
						+ generolegido.getNombre() + ":\n");
				
				elementos = Artistas.Lista_Artistas.elements();
				i=0;
				while(elementos.hasMoreElements()){
					Artista actual=(Artista)elementos.nextElement();
